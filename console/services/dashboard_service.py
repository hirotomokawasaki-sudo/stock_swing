...
class DashboardService:
    ...
    def get_positions(self, trading: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def get_pipeline_summary(self, trading: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def get_news(self, trading: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def _summarize_positions(self, positions: List[Dict[str, Any]], trading: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        trading = trading or {}
        snapshots = trading.get("daily_snapshots", [])
    ...
    def _get_latest_decision_for_symbol(self, symbol: Optional[str]) -> Optional[Dict[str, Any]]:
        if not symbol:
            return None
        decisions_dir = self.project_root / "data" / "decisions"
    ...
    def _derive_position_decision_status(self, decision: Optional[Dict[str, Any]], holding_days: Optional[float] = None) -> str:
        if not decision:
    ...
    def _fetch_current_prices(self, symbols: List[Optional[str]]) -> Dict[str, float]:
    ...
    def get_exit_reason_summary(self, exit_strategy: Optional[str] = None) -> Dict[str, Any]:
    ...
    def get_decision_reasons(self, strategy: Optional[str] = None, days: int = 7, limit: int = 200, symbol: Optional[str] = None) -> Dict[str, Any]:
