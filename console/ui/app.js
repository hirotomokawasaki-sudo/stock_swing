                ...
                : `<table>
                    ...
                    <tbody>${positions.map(p => `
                        <tr>
                            ...
                            <td class="muted small">${p.sizing_details ? `採用=${p.sizing_details.final_shares||'—'} / risk=${p.sizing_details.shares_by_risk||'—'} / notional=${p.sizing_details.shares_by_notional||'—'} / exposure=${p.sizing_details.shares_by_exposure||'—'} / 採用制約=${p.sizing_details.applied_constraint||'—'} / 相場regime=${p.sizing_details.regime_used||'—'}` : '—'}</td>
